...
describe NetboxClientRuby::TenantGroup, faraday_stub: true do
  let(:region_id) { 1 }
  ...
  subject { NetboxClientRuby::TenantGroup.new region_id }
  ...
  describe '.save' do
    ...
    context 'update' do
      ...
      subject do
        entity = NetboxClientRuby::TenantGroup.new region_id
        entity.name = name
        entity.slug = slug
        entity
      end
    ...
    context 'create' do
      ...
      subject do
        entity = NetboxClientRuby::TenantGroup.new
        entity.name = name
        entity.slug = slug
        entity
      end
