...
RSpec.describe NetboxClientRuby::DCIM::RearPorts, faraday_stub: true do
  let(:expected_length) { 1 }
  let(:singular_type) { NetboxClientRuby::DCIM::RearPort }

  let(:response) { File.read('spec/fixtures/dcim/rear-ports.json') }
  let(:request_url) { '/api/dcim/rear-ports/' }
  ...
  describe '#as_array' do
    ...
    it 'returns RearPort instances' do
