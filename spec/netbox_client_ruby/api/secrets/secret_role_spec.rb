...
module NetboxClientRuby
  module Secrets
    RSpec.describe SecretRole, faraday_stub: true do
      let(:secret_id) { 1 }
      ...
      subject { SecretRole.new secret_id }
      ...
      describe '#name' do
        ...
        it 'shall be the expected name' do
          expect(subject.name).to eq('ipmi_password')
        end
      end
      ...
      describe '.update' do
        ...
        it 'should update the object' do
          expect(faraday).to receive(request_method).and_call_original
          expect(subject.update(name: 'noob').name).to eq('ipmi_password')
        end
      end
      ...
      describe '.save' do
        ...
        context 'update' do
          ...
          subject do
            entity = SecretRole.new secret_id
            entity.name = name
            entity
          end
